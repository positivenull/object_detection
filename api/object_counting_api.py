        ...
        with detection_graph.as_default():
          with tf.Session(graph=detection_graph) as sess:
            ...
            while True:
                ...
                # Visualization of the results of a detection.
                counter, csv_line, counting_mode, data = vis_util.visualize_boxes_and_labels_on_image_array(cap.get(1),
                                                                                                      input_frame,
                                                                                                      1,
                                                                                                      is_color_recognition_enabled,
                                                                                                      np.squeeze(boxes),
                ...
                client = udp_client.SimpleUDPClient("localhost", 12345)
                if counting_mode and data:
                    count = int(re.search(r'\d+', counting_mode).group())
                    client.send_message("/centerData", data)
                    client.send_message("/counter", count)
                    print(data)
                    print(count)
