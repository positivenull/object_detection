...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  draw.ellipse([(xCenter-20, yCenter-20), (xCenter+20, yCenter+20)], fill='blue', outline='blue',width=5)
  #print("center: ", center)
  #print("--")
...
def visualize_boxes_and_labels_on_image_array(current_frame_number,
  ...
  for box, color in box_to_color_map.items():
    ...
    # if target object is not declared -
  ...
  if(mode == 1):
    ...
    return counter, csv_line_util, counting_mode, data

  else:
    return counter, csv_line_util, data
